...
<!-- Mirrored from tympanus.net/Freebies/Cardio/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 05 Feb 2022 13:55:33 GMT -->
<head>
	<meta charset="UTF-8">
	...
	<link rel="apple-touch-icon" sizes="57x57" href="<?= base_url('assets/new/img/favicons/apple-touch-icon-57x57.png');?>">
	<link rel="apple-touch-icon" sizes="60x60" href="<?= base_url('assets/new/img/favicons/apple-touch-icon-60x60.png');?>">
	<link rel="icon" type="image/png" href="<?= base_url('assets/new/img/favicons/favicon-32x32.png');?>" sizes="32x32">
	<link rel="icon" type="image/png" href="<?= base_url('assets/new/img/favicons/favicon-16x16.png');?>" sizes="16x16">
	<link rel="manifest" href="<?= base_url('assets/new/img/favicons/manifest.json');?>">
	<link rel="shortcut icon" href="<?= base_url('assets/new/img/favicons/favicon.ico');?>">
	<meta name="msapplication-TileColor" content="#00a8ff">
	<meta name="msapplication-config" content="<?= base_url('assets/new/img/favicons/browserconfig.xml');?>">
	<meta name="theme-color" content="#ffffff">
	<!-- Normalize -->
	<link rel="stylesheet" type="text/css" href="<?= base_url('assets/new/css/normalize.css');?>">
	<!-- Bootstrap -->
	<link rel="stylesheet" type="text/css" href="<?= base_url('assets/new/css/bootstrap.css');?>">
	<!-- Owl -->
	<link rel="stylesheet" type="text/css" href="<?= base_url('assets/new/css/owl.css');?>">
	<!-- Animate.css -->
	<link rel="stylesheet" type="text/css" href="<?= base_url('assets/new/css/animate.css');?>">
	<!-- Font Awesome -->
	<link rel="stylesheet" type="text/css" href="<?= base_url('assets/new/fonts/font-awesome-4.1.0/css/font-awesome.min.css');?>">
	<!-- Elegant Icons -->
	<link rel="stylesheet" type="text/css" href="<?= base_url('assets/new/fonts/eleganticons/et-icons.css')?>">
	<!-- Main style -->
	<link rel="stylesheet" type="text/css" href="<?= base_url('assets/new/css/cardio.css');?>">
...
<body>
	<div class="preloader">
		<img src="<?= base_url('assets/new/img/loader.gif');?>" alt="Preloader image">
	</div>
	<nav class="navbar">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#"><img src="<?= base_url('assets/new/img/logo.png');?>" data-active-url="img/logo-active.png" alt=""></a>
			</div>
		...
		<div class="container">
			...
			<div class="row services">
				<div class="col-md-4">
					<div class="service">
						<div class="icon-holder">
							<img src="<?= base_url('assets/new/img/icons/heart-blue.png');?>" alt="" class="icon">
						</div>
				...
				<div class="col-md-4">
					<div class="service">
						<div class="icon-holder">
							<img src="<?= base_url('assets/new/img/icons/guru-blue.png');?>" alt="" class="icon">
						</div>
				...
				<div class="col-md-4">
					<div class="service">
						<div class="icon-holder">
							<img src="<?= base_url('assets/new/img/icons/weight-blue.png');?>" alt="" class="icon">
						</div>
			...
			<div class="row">
				<div class="col-md-4">
					<div class="team text-center">
						...
						<img src="<?= base_url('assets/new/img/team/team3.jpg')?>" alt="Team Image" class="avatar">
						<div class="title">
							<h4>Ben Adamson</h4>
				...
				<div class="col-md-4">
					<div class="team text-center">
						...
						<img src="<?= base_url('assets/new/img/team/team1.jpg');?>" alt="Team Image" class="avatar">
						<div class="title">
							<h4>Eva Williams</h4>
				...
				<div class="col-md-4">
					<div class="team text-center">
						...
						<img src="<?= base_url('assets/new/img/team/team2.jpg');?>" alt="Team Image" class="avatar">
						<div class="title">
							<h4>John Phillips</h4>
							<h5 class="muted regular">Personal Trainer</h5>
						</div>
	...
	<!-- Scripts -->
	<script src="<?= base_url('assets/new/js/jquery-1.11.1.min.js');?>"></script>
	...
	<script src="<?= base_url('assets/new/js/typewriter.js');?>"></script>
	<script src="<?= base_url('assets/new/js/jquery.onepagenav.js');?>"></script>
	<script src="<?= base_url('assets/new/js/main.js');?>"></script>
</body>


<!-- Mirrored from tympanus.net/Freebies/Cardio/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 05 Feb 2022 13:55:45 GMT -->
</html>
