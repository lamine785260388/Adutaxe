            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Choisir Date</h5>
                    <p class="text-center small">Pour voir son facture!
                      
                    </p>
                  </div>
                   <?php foreach($infras->result() as $row){ 
                    $nom=$row->nomInfrastructure;
                    $add=$row->adresse;
                    $codegerant=$row->id;
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                      ...
                      <span>Nom infrastructure:<?= " ".$nom;?></span><br>
                      <span>adresse infrastructure:<?= " ".$add;?></span><br>
                      <span>Code gerant:<?= " ".$codegerant;?></span><br><br>
                    </div>

                  <form class="row g-3 needs-validation" novalidate method="POST" action="<?php echo site_url('infrastructure/facture');?>">
                   
                    <div class="col-xs-12 col-sm-12 col-md-12">
                      <input type="hidden" name="idinf" value="<?= $idinf;?>">

                      <label for="identification" class="form-label text-danger">Veuillez Choisir une date de déclaration  </label><br>
                      <select class="form-select" name="date">
                      <?php foreach($date->result() as $row){ ?>
                        <option value="<?= $row->date;?>"><?php echo "Date: ".$row->date?></option>
                      <?php };?>
                      </select>
                    </div>
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6">
                      <button style="background-color:green;" class="btn btn-primary w-100" type="submit">Valider</button>
