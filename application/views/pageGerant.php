      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="<?php echo base_url('assets/img/lamine.jpg');?>" alt="Profile" class="rounded-circle">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="<?php echo base_url('gerant/demandeDepaiement');?>">
          ...
          <div class="card">
            <div class="card-body pt-3">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered">
                ...
                <li class="nav-item">
                  <button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-settings">Paramétre</button>
                </li>
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">Abdou diouf</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Nom boutiquee</div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">785260388</div>
                  </div>
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Numéro Cni</div>
                    <div class="col-lg-9 col-md-8">09882873444</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Email</div>
                    <div class="col-lg-9 col-md-8">Abdou diouf@example.com</div>
                  </div>
                  ...
                  <form>
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <img src="<?php echo base_url('assets/img/lamine.jpg');?>" alt="Profile">
                        <div class="pt-2">
                    ...
                    <div class="row mb-3">
                      <label for="company" class="col-md-4 col-lg-3 col-form-label">Nom boutique</label>
                      <div class="col-md-8 col-lg-9">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="country" type="text" class="form-control" id="Country" value="Senegal">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="address" type="text" class="form-control" id="Address" value="Senegal">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                     ...
                     <div class="row mb-3">
                      <label for="CNI" class="col-md-4 col-lg-3 col-form-label">NumeroCni</label>
                      <div class="col-md-8 col-lg-9">
                        <input name="email" type="email" class="form-control" id="Email" value="52662729883">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="email" type="email" class="form-control" id="Email" value="Abdou diouf@example.com">
                      </div>
                    </div>
