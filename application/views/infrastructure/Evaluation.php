                ...
                <div class="card-body">
                  ...
                  enctype="multipart/form-data" novalidate>
                     ...
                     <div class="col-xs-6 col-sm-6 col-md-6">
                      ...
                      <input type="text" name="nom" class="form-control" id="yourName" value="<?= $nominf ;?>" required>
                    </div>
                    <div class="col-xs-6 col-sm-6 col-md-6">
                      <label for="adresse" class="form-label"><strong>adresse</strong></label>
                      <input type="text" name="adresse" class="form-control" id="prenom" value="<?= $address;?>" required>
                    </div>
                    
                    <div class="col-xs-6 col-sm-6 col-md-6">
                      <label for="genre" class="form-label"><strong>genre</strong></label>
                      <select class="form-select" name="genre">
                        <option value="boutique" <?php if($genre!="boutique"){ echo "disabled='disabled'" ;};?>>Boutique</option>
                        <option value="supermarche" <?php if($genre!="supermarche"){ echo "disabled='disabled'" ;};?>>supermarche</option>
                      </select>
                    </div>
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6">
                      ...
                      <input type="hidden" name="id" class="form-control" id="yourName" value="" required>
